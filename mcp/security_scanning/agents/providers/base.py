...
The abstraction allows swapping between different LLM backends (Claude, OpenAI,
Ollama, etc.) while keeping the MCP tool integration unchanged.
"""
...
class LLMResponse:
    ...
    you're using Anthropic, OpenAI, Ollama, or another provider.
    """
    content: str | None
...
class LLMProvider(ABC):
    ...
    def format_tool_results_message(self, tool_results: list[dict]) -> dict:
        ...
        Some providers (Anthropic) nest tool results in a user message.
