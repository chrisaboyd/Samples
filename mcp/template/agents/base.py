...
This module provides the core agentic loop that connects LLMs to MCP servers.
Extend BaseAgent to create your own agents.
"""
...
from .providers import LLMProvider, PoolsideProvider
...
class BaseAgent(ABC):
    ...
    Subclass this and implement the abstract properties to create an agent.
    """
    ...
    def mcp_server_module(self) -> str:
        """Python module path for the MCP server (e.g., 'mcp_servers.your_server.server')."""
        pass
    ...
    async def run(self, task: str, verbose: bool = False) -> str:
        ...
        3. Send task to LLM with tools
        4. Execute any tool calls
        5. Repeat until LLM completes
            ...
            async with ClientSession(read, write) as session:
                ...
                while True:
                    ...
                    if response.stop_reason == "tool_use":
                        ...
                        # Handle both list and dict returns from providers
